...
ALTER TABLE "area"
    ADD CONSTRAINT "uk_226rm1fd8fl8ewh0a7n1k8f94" UNIQUE ("name");

-- changeset OlegM:1681676479940-6
ALTER TABLE "animal_type"
    ADD CONSTRAINT "uk_1glb7dmed18nrsl81lxhnmb48" UNIQUE ("type");
...
ALTER TABLE "location_point"
    ADD CONSTRAINT "ukcucfg4v5jnq70l5fc6jljbvvy" UNIQUE ("latitude", "longitude");
...
(
    ...
    "death_date_time"      TIMESTAMP WITHOUT TIME ZONE,
    "gender"               VARCHAR(255),
    "height"               FLOAT4,
    "length"               FLOAT4,
...
CREATE TABLE "animal_animal_types"
(
    "animal_id"      BIGINT NOT NULL,
    "animal_type_id" BIGINT NOT NULL,
    CONSTRAINT "animal_animal_types_pkey" PRIMARY KEY ("animal_id", "animal_type_id")
);
...
ALTER TABLE "animal_visited_location"
    ADD CONSTRAINT "fk2kimptt82y77fegciagy6dvqo" FOREIGN KEY ("animal_id") REFERENCES "animal" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset OlegM:1681676479940-18
ALTER TABLE "animal_animal_types"
    ADD CONSTRAINT "fk58n2m6wwlr5n3wn1g3y48ixdv" FOREIGN KEY ("animal_type_id") REFERENCES "animal_type" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset OlegM:1681676479940-19
ALTER TABLE "animal"
    ADD CONSTRAINT "fk9wcnph6oxn6e1dtdsal345fhl" FOREIGN KEY ("chipper_id") REFERENCES "account" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset OlegM:1681676479940-20
ALTER TABLE "animal_visited_location"
    ADD CONSTRAINT "fkd9yfuf4y98xak8bwjeo4uaxwh" FOREIGN KEY ("location_point_id") REFERENCES "location_point" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset OlegM:1681676479940-21
ALTER TABLE "animal"
    ADD CONSTRAINT "fkm1uiqh857r8l8ed5edjdymnjy" FOREIGN KEY ("chipping_location_id") REFERENCES "location_point" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset OlegM:1681676479940-22
ALTER TABLE "animal_animal_types"
    ADD CONSTRAINT "fkomvtmbwt675d3mmbmbttvuce9" FOREIGN KEY ("animal_id") REFERENCES "animal" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;
